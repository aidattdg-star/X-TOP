  ...
  return (
    <TooltipProvider delayDuration={0}>
      <div className="min-h-screen flex w-full bg-background">
        {/* Rail reserva o espaço; o painel interno expande por cima no hover (sem empurrar o conteúdo) */}
        <aside
          className={cn(
            "relative shrink-0 sticky top-0 h-screen z-30 transition-[width] duration-300 ease-in-out",
